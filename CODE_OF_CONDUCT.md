...
GitHub repository (issues, pull requests, discussions, code review), and
...
Because this project is used in **clinical research and clinical trial**
contexts, contributors are additionally expected to:

- **Protect privacy.** Never commit patient-level data, real subject
  identifiers, or any file that may contain PHI / PII. Use only synthetic
  or fully de-identified example data in tests, examples, and tutorials.
- **Respect licensing.** Each skill may carry its own license or be
  subject to third-party data-source terms. Check the relevant `SKILL.md`
  and `THIRD_PARTY_NOTICES.md` before redistributing derived content.
- **Stay evidence-based.** When a skill encodes a clinical workflow
  (eligibility criteria, statistical tests, reporting templates), prefer
  conservative interpretations of public guidance (e.g. CONSORT, CARE,
  ICH-E3) over local convention. Cite the source in the skill's
  `SKILL.md` whenever practical.
- **Disclose conflicts.** If you have a financial, professional, or
  personal interest in a vendor, product, or service that a contribution
  touches, declare it in the corresponding issue or PR.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the community leaders responsible for enforcement via the
contact channels listed in [`SECURITY.md`](./SECURITY.md). All complaints
