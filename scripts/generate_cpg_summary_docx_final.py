...
summary_text = (
    ...
    "值得注意的是，相较于如 Shingrix (AS01B 脂质体佐剂系统) 等其他强效新型佐剂，CpG 1018 及其联合铝佐剂的方案在诱导高水平体液及细胞免疫的同时，"
    ...
    "各组与安慰剂或传统铝佐剂对照组保持了高度相似且处于极低水平（多数<0.1%）。\n\n"
    "3. 特征性生理反应的安全可控性：\n"
    ...
    "结论：CpG 1018 及同类寡核苷酸佐剂通过针对 TLR-9 的高特异性激活，在保证极高抗原血清保护率（SPR）的同时，成功剥离了传统强效佐剂常伴随的高反应原性。基于累计数万例严谨的大规模临床试验安全性数据的确证，以及 FDA 官方审评的背书，证实了其作为下一代“高效低毒”通用型人用疫苗佐剂平台的坚实安全性潜力。"
)
