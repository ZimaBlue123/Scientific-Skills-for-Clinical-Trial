...
def identify_section(text):
    ...
    section_patterns = [
        ...
        ('5. inventory of clinical trials ongoing and completed during the reporting period', 'sec5_inventory'),
...
def transfer_content(template_path, source_path, output_path):
    ...
    if template_doc.tables:
        ...
        # Update sponsor name
        sponsor_table.rows[0].cells[1].text = 'Grand Theravac Life Sciences (Nanjing) Co., Ltd. / Grand Theravac Life Sciences (Hangzhou) Co., Ltd.'
        # Update address
