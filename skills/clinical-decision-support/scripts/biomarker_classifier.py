...
def main():
    ...
    parser.add_argument(
        "-b", "--biomarker", type=str, default=None, help="Biomarker column name for stratification"
    )
    parser.add_argument(
        "-t", "--threshold", type=float, default=None, help="Threshold for binary classification"
    )
    parser.add_argument(
        "-o", "--output-dir", type=str, default="stratification", help="Output directory"
    )
